...
random_key:
	python3 scripts/setup_route.py $(CANISTER_ID_FRONTEND) page2 --random-key --params "key=value"

production_ic:
	python3 scripts/setup_route.py $(CANISTER_ID_FRONTEND) page1 --params "key=value" --ic
